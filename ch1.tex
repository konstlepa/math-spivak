...
\bigskip \emph{(P2)} (Existense of an additive identity) \enspace We have
\begin{align*}
...
\bigskip \emph{(P8)} (Commutative law for multiplication) \enspace Because $0 \cdot 1 = 1 \cdot 0$, we deduce that $a \cdot b = b \cdot a$.
